...
class RawFunctions:
    ...
    async def imggen(
        ...
        **kwargs: dict
        ...
        url = await cli_obj.images.generate(
            model=model,
            prompt=prompt,
            provider=provider,
            response_format="url",
    ...
    async def text_n_vision(
        ...
        **kwargs: dict
        ...
        response = await cli_obj.chat.completions.create(
            messages=messages,
    ...
    async def image_variation(
        ...
        **kwargs: dict
        ...
        response = await cli_obj.images.create_variation(
    ...
    async def videogen(
        ...
        **kwargs: dict
        ...
        result = await cli_obj.media.generate(
            provider=provider,
            model=model,
            prompt=prompt,
            response_format="url",
